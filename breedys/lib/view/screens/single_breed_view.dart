...
import 'package:great_places/view/single_item_view.dart';
import 'package:great_places/view_models/single_breed_view_model.dart';
import 'dart:io';
...
class SingleBreedViewState extends State<SingleBreedView> {
  ...
  Widget build(BuildContext context) {
    return Platform.isIOS
        ? _createCupertinoPageScaffold(name)
        : _createScaffold(name);
  }
  ...
  CupertinoPageScaffold _createCupertinoPageScaffold(String name) {
    var navBar = CupertinoNavigationBar(middle: Text(name.toUpperCase()));
    ...
    return CupertinoPageScaffold(
      ...
      child: SafeArea(
        ...
        child: ChangeNotifierProvider<SingleBreedViewModel>(
          ...
          child:
              Consumer<SingleBreedViewModel>(builder: (context, viewModel, _) {
